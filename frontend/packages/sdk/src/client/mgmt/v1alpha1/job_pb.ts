...
export type JobTypeConfig_JobTypePiiDetect_DataSampling = Message<"mgmt.v1alpha1.JobTypeConfig.JobTypePiiDetect.DataSampling"> & {
   ...
   *
   * @generated from field: mgmt.v1alpha1.JobTypeConfig.JobTypePiiDetect.DataSampling.SamplingMode mode = 2;
   */
  mode: JobTypeConfig_JobTypePiiDetect_DataSampling_SamplingMode;
};
 ...
 *
 * @generated from enum mgmt.v1alpha1.JobTypeConfig.JobTypePiiDetect.DataSampling.SamplingMode
 */
export enum JobTypeConfig_JobTypePiiDetect_DataSampling_SamplingMode {
  /**
   * Unspecified falls back to the legacy is_enabled boolean (true maps to SAMPLING_MODE_RAW).
   *
   * @generated from enum value: SAMPLING_MODE_UNSPECIFIED = 0;
   */
  UNSPECIFIED = 0,
   ...
   *
   * @generated from enum value: SAMPLING_MODE_NONE = 1;
   */
  NONE = 1,
   ...
   *
   * @generated from enum value: SAMPLING_MODE_PROFILE = 2;
   */
  PROFILE = 2,
   ...
   *
   * @generated from enum value: SAMPLING_MODE_RAW = 3;
   */
  RAW = 3,
}

/**
 * Describes the enum mgmt.v1alpha1.JobTypeConfig.JobTypePiiDetect.DataSampling.SamplingMode.
 */
export const JobTypeConfig_JobTypePiiDetect_DataSampling_SamplingModeSchema: GenEnum<JobTypeConfig_JobTypePiiDetect_DataSampling_SamplingMode> = /*@__PURE__*/
  enumDesc(file_mgmt_v1alpha1_job, 43, 1, 1, 0);
...
/**
 * @generated from message mgmt.v1alpha1.GetJobMappingRecommendationsRequest
 */
export type GetJobMappingRecommendationsRequest = Message<"mgmt.v1alpha1.GetJobMappingRecommendationsRequest"> & {
  /**
   * The unique identifier of the account
   *
   * @generated from field: string account_id = 1;
...
/**
 * Describes the message mgmt.v1alpha1.GetJobMappingRecommendationsRequest.
 * Use `create(GetJobMappingRecommendationsRequestSchema)` to create a new message.
 */
export const GetJobMappingRecommendationsRequestSchema: GenMessage<GetJobMappingRecommendationsRequest> = /*@__PURE__*/
  messageDesc(file_mgmt_v1alpha1_job, 158);

/**
 * @generated from message mgmt.v1alpha1.GetJobMappingRecommendationsResponse
 */
export type GetJobMappingRecommendationsResponse = Message<"mgmt.v1alpha1.GetJobMappingRecommendationsResponse"> & {
  /**
   * The list of recommended transformer configurations, one per detected column
   *
   * @generated from field: repeated mgmt.v1alpha1.TransformerRecommendation recommendations = 1;
   */
   ...
   *
   * @generated from field: optional string report_run_id = 2;
   */
  reportRunId?: string | undefined;
};

/**
 * Describes the message mgmt.v1alpha1.GetJobMappingRecommendationsResponse.
 * Use `create(GetJobMappingRecommendationsResponseSchema)` to create a new message.
 */
export const GetJobMappingRecommendationsResponseSchema: GenMessage<GetJobMappingRecommendationsResponse> = /*@__PURE__*/
 ...
 *
 * @generated from message mgmt.v1alpha1.TransformerRecommendation
 */
export type TransformerRecommendation = Message<"mgmt.v1alpha1.TransformerRecommendation"> & {
  /**
   * The schema of the table
   *
   * @generated from field: string schema = 1;
   ...
   *
   * @generated from field: mgmt.v1alpha1.TransformerConfig recommended_config = 5;
   */
  recommendedConfig?: TransformerConfig | undefined;
   ...
   *
   * @generated from field: repeated mgmt.v1alpha1.DetectionEvidence evidence = 7;
   */
   ...
   *
   * @generated from field: optional mgmt.v1alpha1.NewTransformerProposal proposal = 8;
   */
  proposal?: NewTransformerProposal | undefined;
};

/**
 * Describes the message mgmt.v1alpha1.TransformerRecommendation.
 * Use `create(TransformerRecommendationSchema)` to create a new message.
 */
export const TransformerRecommendationSchema: GenMessage<TransformerRecommendation> = /*@__PURE__*/
  messageDesc(file_mgmt_v1alpha1_job, 160);

/**
 * A single piece of evidence that contributed to a detection/recommendation
 *
 * @generated from message mgmt.v1alpha1.DetectionEvidence
 */
export type DetectionEvidence = Message<"mgmt.v1alpha1.DetectionEvidence"> & {
  /**
   * The kind of detector that produced this evidence
   *
   * @generated from field: mgmt.v1alpha1.DetectionEvidence.DetectorKind kind = 1;
   */
  kind: DetectionEvidence_DetectorKind;
...
/**
 * Describes the message mgmt.v1alpha1.DetectionEvidence.
 * Use `create(DetectionEvidenceSchema)` to create a new message.
 */
export const DetectionEvidenceSchema: GenMessage<DetectionEvidence> = /*@__PURE__*/
  messageDesc(file_mgmt_v1alpha1_job, 161);

/**
 * The kind of detector that produced a piece of evidence
 *
 * @generated from enum mgmt.v1alpha1.DetectionEvidence.DetectorKind
 */
export enum DetectionEvidence_DetectorKind {
  /**
   * @generated from enum value: DETECTOR_KIND_UNSPECIFIED = 0;
   */
  UNSPECIFIED = 0,

  /**
   * @generated from enum value: DETECTOR_KIND_REGEX = 1;
   */
  REGEX = 1,

  /**
   * @generated from enum value: DETECTOR_KIND_DICTIONARY = 2;
   */
  DICTIONARY = 2,

  /**
   * @generated from enum value: DETECTOR_KIND_LLM = 3;
   */
  LLM = 3,
}

/**
 * Describes the enum mgmt.v1alpha1.DetectionEvidence.DetectorKind.
 */
export const DetectionEvidence_DetectorKindSchema: GenEnum<DetectionEvidence_DetectorKind> = /*@__PURE__*/
  enumDesc(file_mgmt_v1alpha1_job, 161, 0);

/**
 * A proposal to create a new user-defined transformer for a column whose format does not match any system transformer
 *
 * @generated from message mgmt.v1alpha1.NewTransformerProposal
 */
export type NewTransformerProposal = Message<"mgmt.v1alpha1.NewTransformerProposal"> & {
  /**
   ...
   *
   * @generated from field: string javascript_code = 3;
   */
...
/**
 * Describes the message mgmt.v1alpha1.NewTransformerProposal.
 * Use `create(NewTransformerProposalSchema)` to create a new message.
 */
export const NewTransformerProposalSchema: GenMessage<NewTransformerProposal> = /*@__PURE__*/
...
export const JobService: GenService<{
   ...
   *
   * @generated from rpc mgmt.v1alpha1.JobService.GetJobMappingRecommendations
   */
  getJobMappingRecommendations: {
    methodKind: "unary";
    input: typeof GetJobMappingRecommendationsRequestSchema;
    output: typeof GetJobMappingRecommendationsResponseSchema;
  },
}> = /*@__PURE__*/
