...
<head>
    <title>{{ .Title }}</title>
    <link rel="icon" type="image/png" href="https://assets.fishtre-compagnie.com/husonym/newbrand/favicon_transparent.ico" />
    <style>
        body {
...
<body>
  ...
  <div>
      <img class='logo' src="https://assets.fishtre-compagnie.com/husonym/app/cliImage.png">
  </div>
	`
    ...
    <div>
        <img class='logo' src="https://assets.fishtre-compagnie.com/husonym/app/angryDarth.jpg">
    </div>
	`
)
