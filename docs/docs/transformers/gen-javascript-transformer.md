...
const newValue = husonym.transformCharacterScramble(value, {
	userProvidedRegex: "", 
	seed: 1, 
});
...
const newValue = husonym.transformE164PhoneNumber(value, {
...
const newValue = husonym.transformEmail(value, {
	preserveLength: false,
...
const newValue = husonym.transformFirstName(value, {
	maxLength: 100,
	preserveLength: false,
	seed: 1, 
});
...
const newValue = husonym.transformFloat64(value, {
...
const newValue = husonym.transformFullName(value, {
	maxLength: 100,
	preserveLength: false,
	seed: 1, 
});
...
const newValue = husonym.transformInt64(value, {
	randomizationRangeMin: 1,
	randomizationRangeMax: 10000,
	seed: 1, 
});
...
const newValue = husonym.transformInt64PhoneNumber(value, {
	preserveLength: false,
	seed: 1, 
});
...
const newValue = husonym.transformLastName(value, {
	maxLength: 100,
	preserveLength: false,
	seed: 1, 
});
...
const newValue = husonym.transformString(value, {
	preserveLength: false,
	minLength: 1,
	maxLength: 100,
	seed: 1, 
...
const newValue = husonym.transformStringPhoneNumber(value, {
	preserveLength: false,
	maxLength: 100,
	seed: 1, 
});
...
const newValue = husonym.transformUuid(value, {
	seed: 1, 
});
...
const newValue = husonym.generateBool({
	seed: 1, 
});
...
const newValue = husonym.generateBusinessName({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = husonym.generateCardNumber({
	validLuhn: false,
	seed: 1, 
});
...
const newValue = husonym.generateCategorical({
...
const newValue = husonym.generateCity({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = husonym.generateCountry({
...
const newValue = husonym.generateEmail({
	maxLength: 100000,
	emailType: 'uuidv4',
	seed: 1, 
});
...
const newValue = husonym.generateFirstName({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = husonym.generateFloat64({
	randomizeSign: false,
	min: 1,
	max: 10000,
	precision: 1, 
...
const newValue = husonym.generateFullAddress({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = husonym.generateFullName({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = husonym.generateGender({
	abbreviate: false,
	maxLength: 100,
	seed: 1, 
});
...
const newValue = husonym.generateInt64({
	randomizeSign: false,
	min: 1,
	max: 10000,
	seed: 1, 
...
const newValue = husonym.generateInt64PhoneNumber({
	seed: 1, 
});
...
const newValue = husonym.generateInternationalPhoneNumber({
	min: 9,
	max: 15,
	seed: 1, 
});
...
const newValue = husonym.generateIpAddress({
	maxLength: 100000,
...
const newValue = husonym.generateLastName({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = husonym.generateRandomString({
	min: 1,
	max: 100,
	seed: 1, 
});
...
const newValue = husonym.generateSHA256Hash({});
...
const newValue = husonym.generateSSN({
	seed: 1, 
});
...
const newValue = husonym.generateState({
	generateFullName: false,
	seed: 1, 
});
...
const newValue = husonym.generateStreetAddress({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = husonym.generateStringPhoneNumber({
	min: 9,
	max: 15,
	seed: 1, 
});
...
const newValue = husonym.generateUnixTimestamp({
	seed: 1, 
});
...
const newValue = husonym.generateUsername({
	maxLength: 100,
	seed: 1, 
});
...
const newValue = husonym.generateUTCTimestamp({
	seed: 1, 
});
...
const newValue = husonym.generateUUID({
	includeHyphens: true,
});
...
const newValue = husonym.generateZipcode({
	seed: 1, 
});
