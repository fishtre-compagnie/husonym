---
title: Introduction
description: Learn about Husonym transformers and how you can use them to anonymize data and generate synthetic data
id: introduction
hide_title: false
...
Transformers are defined in the job workflow and are applied to every piece of data in the column they are assigned. Husonym ships with over 40 pre-defined transformers that make it fast and easy to get started.

![udt](https://assets.fishtre-compagnie.com/husonym/docs/udt-home.png)

## Transformer Types

There are two types of transformers:

1. System Transformers - Pre-built and configured transformers that automatically come with Husonym out of the box. These cannot be deleted but they can be cloned.
