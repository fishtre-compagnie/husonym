---
title: Introduction
description: Husonym is an open-source, developer-first way to anonymize PII, generate synthetic data and sync environments for better testing, debugging and developer experience
id: intro
hide_title: false
slug: /
---
...
# Welcome to the Husonym Docs

Husonym is an open-source, developer-first way to anonymize PII, generate synthetic data and sync environments for better
testing, debugging and developer experience.

<ThemedImage
  alt="Husonym header"
  sources={{
    light: 'https://assets.fishtre-compagnie.com/husonym/docs/husonym-header.svg',
    dark: 'https://assets.fishtre-compagnie.com/husonym/docs/husonym-header-dark.svg',
  }}
/>

## Core Features

Husonym has four core features that deliver value to developers and engineering teams. Click on each one below to learn more.
...
Husonym can be used in many different ways to support different use-cases. Check out the most common use-cases below.
...
Once you're ready to deploy Husonym, check out our Deployment guide to see the available deployment options.

<CustomCard
  title="Deploy"
  description="Learn how to deploy Husonym using Docker Compose or Kubernetes. "
...
We love contributors and are happy to accept PRs. The best way to contribute to Husonym is to go ahead and try out it. If you find something is not right, you can report an issue [here](https://github.com/fishtre-compagnie/husonym/issues/new?assignees=&labels=bug&template=bug_report.md).
