---
title: Husonym IP Ranges
description: Learn how to give Husonym Cloud access to your resources
id: husonym-ip-ranges
hide_title: false
slug: /guides/husonym-ip-ranges
# cSpell:words Husonym
---

## Introduction

Husonym Cloud needs to access your data sources so that it can help you configure jobs as well as synchronize data.
...
The following IP addresses are for Husonym Cloud's available regions.
