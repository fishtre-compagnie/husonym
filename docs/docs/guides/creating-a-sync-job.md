...
![job-define](https://assets.husonym.com/husonym/docs/new-sync-job-definition.png)
...
![job-connect](https://assets.husonym.com/husonym/docs/new-sync-job-connections.png)
...
![job-subset](https://assets.husonym.com/husonym/docs/new-sync-job-subset.png)
