...
![job-define](https://assets.fishtre-compagnie.com/husonym/docs/new-sync-job-definition.png)
...
![job-connect](https://assets.fishtre-compagnie.com/husonym/docs/new-sync-job-connections.png)

5. Next is the Schema page. Here you can select how you want to transform your tables and columns with [**Transformers**](/core-concepts#transformers). There are a number of [transformers](/transformers/system) that Husonym ships with out of the box or you can create your own custom transformer.
...
![job-subset](https://assets.fishtre-compagnie.com/husonym/docs/new-sync-job-subset.png)
