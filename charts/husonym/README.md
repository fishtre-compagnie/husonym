...
* <https://github.com/fishtre-compagnie/husonym>
...
| api.ee.license | string | `nil` | Husonym Enterprise-Edition License Key |
...
| api.kubernetes.workerAppName | string | `"husonym-worker"` | Corresponds with the app label that is present on the worker pod |
...
| api.migrations.db.migrationsTableName | string | `"husonym_api_schema_migrations"` | This is the tablename that will be created in the postgres "public" schema |
...
| api.runLogs.podConfig.workerAppName | string | `"husonym-worker"` | Corresponds to the app label that is present on the worker pod that will be used to surface logs |
...
| worker.ee.license | string | `nil` | Husonym Enterprise-Edition License Key |
