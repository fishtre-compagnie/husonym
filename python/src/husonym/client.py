...
from husonym.mgmt.v1alpha1 import (
...
class Husonym:
    """A client for interacting with the Husonym API.

    This class provides access to various Husonym services including connections,
    jobs, metrics, transformers, and more. It handles authentication and
    communication with the Husonym API endpoints.
    ...
    Example:
        >>> client = Husonym(access_token="your-token")
    ...
    def __init__(
        ...
        api_url: Optional[str] = _DEFAULT_HUSONYM_CLOUD_API_URL,
