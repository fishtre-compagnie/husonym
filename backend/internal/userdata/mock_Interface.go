...
// GetUser provides a mock function for the type MockInterface
func (_mock *MockInterface) GetUser(ctx context.Context) (*User, error) {
...
func (_c *MockInterface_GetUser_Call) Return(user *User, err error) *MockInterface_GetUser_Call {
	_c.Call.Return(user, err)
	return _c
}

func (_c *MockInterface_GetUser_Call) RunAndReturn(run func(ctx context.Context) (*User, error)) *MockInterface_GetUser_Call {
	_c.Call.Return(run)
	return _c
}
