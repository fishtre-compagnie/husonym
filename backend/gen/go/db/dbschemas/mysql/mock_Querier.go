...
// GetMysqlRolePermissions provides a mock function for the type MockQuerier
func (_mock *MockQuerier) GetMysqlRolePermissions(ctx context.Context, db DBTX) ([]*GetMysqlRolePermissionsRow, error) {
	ret := _mock.Called(ctx, db)
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, DBTX) ([]*GetMysqlRolePermissionsRow, error)); ok {
		return returnFunc(ctx, db)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, DBTX) []*GetMysqlRolePermissionsRow); ok {
		r0 = returnFunc(ctx, db)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockQuerier_GetMysqlRolePermissions_Call) Return(getMysqlRolePermissionsRows []*GetMysqlRolePermissionsRow, err error) *MockQuerier_GetMysqlRolePermissions_Call {
	_c.Call.Return(getMysqlRolePermissionsRows, err)
	return _c
}

func (_c *MockQuerier_GetMysqlRolePermissions_Call) RunAndReturn(run func(ctx context.Context, db DBTX) ([]*GetMysqlRolePermissionsRow, error)) *MockQuerier_GetMysqlRolePermissions_Call {
	_c.Call.Return(run)
	return _c
}
