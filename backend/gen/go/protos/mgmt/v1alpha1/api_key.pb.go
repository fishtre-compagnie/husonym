...
const file_mgmt_v1alpha1_api_key_proto_rawDesc = "" +
	...
	"\rcreated_by_id\x18\x04 \x01(\tR\vcreatedById\x129\n" +
	"\n" +
	"created_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x12\"\n" +
	"\rupdated_by_id\x18\x06 \x01(\tR\vupdatedById\x129\n" +
	"\n" +
	"updated_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\x12 \n" +
	"\tkey_value\x18\b \x01(\tH\x00R\bkeyValue\x88\x01\x01\x12\x17\n" +
	...
	"\x19GetAccountApiKeysResponse\x127\n" +
	"\bapi_keys\x18\x01 \x03(\v2\x1c.mgmt.v1alpha1.AccountApiKeyR\aapiKeys\"3\n" +
	"\x17GetAccountApiKeyRequest\x12\x18\n" +
	"\x02id\x18\x01 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\x02id\"Q\n" +
	"\x18GetAccountApiKeyResponse\x125\n" +
	"\aapi_key\x18\x01 \x01(\v2\x1c.mgmt.v1alpha1.AccountApiKeyR\x06apiKey\"\x89\x01\n" +
	"\x1eRegenerateAccountApiKeyRequest\x12\x18\n" +
	"\x02id\x18\x01 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\x02id\x12M\n" +
	"\n" +
	"expires_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x12\xbaH\x0f\xc8\x01\x01\xb2\x01\tJ\x05\b\x80\xe7\x84\x0f@\x01R\texpiresAt\"X\n" +
	"\x1fRegenerateAccountApiKeyResponse\x125\n" +
...
var (
	...
	file_mgmt_v1alpha1_api_key_proto_rawDescData []byte
)

func file_mgmt_v1alpha1_api_key_proto_rawDescGZIP() []byte {
	file_mgmt_v1alpha1_api_key_proto_rawDescOnce.Do(func() {
		file_mgmt_v1alpha1_api_key_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mgmt_v1alpha1_api_key_proto_rawDesc), len(file_mgmt_v1alpha1_api_key_proto_rawDesc)))
	})
...
func file_mgmt_v1alpha1_api_key_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mgmt_v1alpha1_api_key_proto_rawDesc), len(file_mgmt_v1alpha1_api_key_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   1,
