...
func (_m *MockJobServiceClient) GetJobMappingRecommendations(_a0 context.Context, _a1 *connect.Request[mgmtv1alpha1.GetJobMappingRecommendationsRequest]) (*connect.Response[mgmtv1alpha1.GetJobMappingRecommendationsResponse], error) {
	ret := _m.Called(_a0, _a1)
...
// MockJobServiceClient_GetJobMappingRecommendations_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetJobMappingRecommendations'
type MockJobServiceClient_GetJobMappingRecommendations_Call struct {
	*mock.Call
}
...
func (_e *MockJobServiceClient_Expecter) GetJobMappingRecommendations(_a0 interface{}, _a1 interface{}) *MockJobServiceClient_GetJobMappingRecommendations_Call {
	return &MockJobServiceClient_GetJobMappingRecommendations_Call{Call: _e.mock.On("GetJobMappingRecommendations", _a0, _a1)}
}

func (_c *MockJobServiceClient_GetJobMappingRecommendations_Call) Run(run func(_a0 context.Context, _a1 *connect.Request[mgmtv1alpha1.GetJobMappingRecommendationsRequest])) *MockJobServiceClient_GetJobMappingRecommendations_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockJobServiceClient_GetJobMappingRecommendations_Call) Return(_a0 *connect.Response[mgmtv1alpha1.GetJobMappingRecommendationsResponse], _a1 error) *MockJobServiceClient_GetJobMappingRecommendations_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockJobServiceClient_GetJobMappingRecommendations_Call) RunAndReturn(run func(context.Context, *connect.Request[mgmtv1alpha1.GetJobMappingRecommendationsRequest]) (*connect.Response[mgmtv1alpha1.GetJobMappingRecommendationsResponse], error)) *MockJobServiceClient_GetJobMappingRecommendations_Call {
	_c.Call.Return(run)
	return _c
}
