...
// GetJobMappingRecommendations provides a mock function with given fields: _a0, _a1
func (_m *MockJobServiceHandler) GetJobMappingRecommendations(_a0 context.Context, _a1 *connect.Request[mgmtv1alpha1.GetJobMappingRecommendationsRequest]) (*connect.Response[mgmtv1alpha1.GetJobMappingRecommendationsResponse], error) {
	ret := _m.Called(_a0, _a1)

	if len(ret) == 0 {
		panic("no return value specified for GetJobMappingRecommendations")
	}

	var r0 *connect.Response[mgmtv1alpha1.GetJobMappingRecommendationsResponse]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *connect.Request[mgmtv1alpha1.GetJobMappingRecommendationsRequest]) (*connect.Response[mgmtv1alpha1.GetJobMappingRecommendationsResponse], error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *connect.Request[mgmtv1alpha1.GetJobMappingRecommendationsRequest]) *connect.Response[mgmtv1alpha1.GetJobMappingRecommendationsResponse]); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*connect.Response[mgmtv1alpha1.GetJobMappingRecommendationsResponse])
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *connect.Request[mgmtv1alpha1.GetJobMappingRecommendationsRequest]) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// MockJobServiceHandler_GetJobMappingRecommendations_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetJobMappingRecommendations'
type MockJobServiceHandler_GetJobMappingRecommendations_Call struct {
	*mock.Call
}

// GetJobMappingRecommendations is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 *connect.Request[mgmtv1alpha1.GetJobMappingRecommendationsRequest]
func (_e *MockJobServiceHandler_Expecter) GetJobMappingRecommendations(_a0 interface{}, _a1 interface{}) *MockJobServiceHandler_GetJobMappingRecommendations_Call {
	return &MockJobServiceHandler_GetJobMappingRecommendations_Call{Call: _e.mock.On("GetJobMappingRecommendations", _a0, _a1)}
}

func (_c *MockJobServiceHandler_GetJobMappingRecommendations_Call) Run(run func(_a0 context.Context, _a1 *connect.Request[mgmtv1alpha1.GetJobMappingRecommendationsRequest])) *MockJobServiceHandler_GetJobMappingRecommendations_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*connect.Request[mgmtv1alpha1.GetJobMappingRecommendationsRequest]))
	})
	return _c
}

func (_c *MockJobServiceHandler_GetJobMappingRecommendations_Call) Return(_a0 *connect.Response[mgmtv1alpha1.GetJobMappingRecommendationsResponse], _a1 error) *MockJobServiceHandler_GetJobMappingRecommendations_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockJobServiceHandler_GetJobMappingRecommendations_Call) RunAndReturn(run func(context.Context, *connect.Request[mgmtv1alpha1.GetJobMappingRecommendationsRequest]) (*connect.Response[mgmtv1alpha1.GetJobMappingRecommendationsResponse], error)) *MockJobServiceHandler_GetJobMappingRecommendations_Call {
	_c.Call.Return(run)
	return _c
}
