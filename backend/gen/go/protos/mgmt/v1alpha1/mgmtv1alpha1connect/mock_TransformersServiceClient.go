...
// TryJavascriptRules provides a mock function with given fields: _a0, _a1
func (_m *MockTransformersServiceClient) TryJavascriptRules(_a0 context.Context, _a1 *connect.Request[mgmtv1alpha1.TryJavascriptRulesRequest]) (*connect.Response[mgmtv1alpha1.TryJavascriptRulesResponse], error) {
	ret := _m.Called(_a0, _a1)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *connect.Request[mgmtv1alpha1.TryJavascriptRulesRequest]) (*connect.Response[mgmtv1alpha1.TryJavascriptRulesResponse], error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *connect.Request[mgmtv1alpha1.TryJavascriptRulesRequest]) *connect.Response[mgmtv1alpha1.TryJavascriptRulesResponse]); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *connect.Request[mgmtv1alpha1.TryJavascriptRulesRequest]) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
//   - _a0 context.Context
//   - _a1 *connect.Request[mgmtv1alpha1.TryJavascriptRulesRequest]
func (_e *MockTransformersServiceClient_Expecter) TryJavascriptRules(_a0 interface{}, _a1 interface{}) *MockTransformersServiceClient_TryJavascriptRules_Call {
	return &MockTransformersServiceClient_TryJavascriptRules_Call{Call: _e.mock.On("TryJavascriptRules", _a0, _a1)}
}

func (_c *MockTransformersServiceClient_TryJavascriptRules_Call) Run(run func(_a0 context.Context, _a1 *connect.Request[mgmtv1alpha1.TryJavascriptRulesRequest])) *MockTransformersServiceClient_TryJavascriptRules_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*connect.Request[mgmtv1alpha1.TryJavascriptRulesRequest]))
	})
	return _c
}

func (_c *MockTransformersServiceClient_TryJavascriptRules_Call) Return(_a0 *connect.Response[mgmtv1alpha1.TryJavascriptRulesResponse], _a1 error) *MockTransformersServiceClient_TryJavascriptRules_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockTransformersServiceClient_TryJavascriptRules_Call) RunAndReturn(run func(context.Context, *connect.Request[mgmtv1alpha1.TryJavascriptRulesRequest]) (*connect.Response[mgmtv1alpha1.TryJavascriptRulesResponse], error)) *MockTransformersServiceClient_TryJavascriptRules_Call {
	_c.Call.Return(run)
	return _c
}
