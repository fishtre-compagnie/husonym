...
func TestClassify(t *testing.T) {
	cases := []struct {
		...
		{"email simple", "email", "text", true, "email", true, mgmtv1alpha1.TransformerSource_TRANSFORMER_SOURCE_GENERATE_EMAIL},
		{
			...
			"email",
			true,
			mgmtv1alpha1.TransformerSource_TRANSFORMER_SOURCE_GENERATE_EMAIL,
		},
		{
			"email camelCase",
			"customerEmail",
		...
		},
		{
			...
			"phone_number",
			true,
			mgmtv1alpha1.TransformerSource_TRANSFORMER_SOURCE_GENERATE_INT64_PHONE_NUMBER,
		},
		{
			"tel token",
			"tel",
		...
		},
		{
			...
			"person_last_name",
			true,
			mgmtv1alpha1.TransformerSource_TRANSFORMER_SOURCE_GENERATE_LAST_NAME,
		},
		{
			"lastname",
			"lastName",
