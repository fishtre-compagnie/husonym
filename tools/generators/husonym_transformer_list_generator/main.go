...
import (
	...
	transformers_utils "github.com/fishtre-compagnie/husonym/worker/pkg/benthos/transformers"
)
...
func main() {
	...
	output := "gen_husonym_transformers.go"
...
const codeTemplate = `
// Code generated by Husonym husonym_transformer_list_generator.go. DO NOT EDIT.

package {{.PackageName}}

func GetHusonymTransformers() []HusonymTransformer {
	return []HusonymTransformer{
...
func GetHusonymGenerators() []HusonymGenerator {
	return []HusonymGenerator{
...
func generateCode(transformers, generators []string, pkgName string) (string, error) {
	...
	t := template.Must(template.New("husonymTransformerList").Parse(codeTemplate))
