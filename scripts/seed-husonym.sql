INSERT INTO husonym_api.users (id)
VALUES
  ('00000000-0000-0000-0000-000000000000')
ON CONFLICT DO NOTHING;
--
INSERT INTO husonym_api.accounts (id, account_type, account_slug)
VALUES
  ('43c71652-b3f7-4dbb-87c2-508075496054', 0, 'personal')
ON CONFLICT DO NOTHING;
--
INSERT INTO husonym_api.account_user_associations (account_id, user_id)
VALUES
  ('43c71652-b3f7-4dbb-87c2-508075496054', '00000000-0000-0000-0000-000000000000')
ON CONFLICT DO NOTHING;
--
INSERT INTO husonym_api.connections (id, "name", account_id, connection_config, created_by_id, updated_by_id)
VALUES
