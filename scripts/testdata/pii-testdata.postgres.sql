...
DROP TABLE IF EXISTS public.donnees_brutes;
...
CREATE TABLE public.donnees_brutes (
  id INT NOT NULL PRIMARY KEY,
  col_1 VARCHAR(100),
  col_2 VARCHAR(100),
  col_3 VARCHAR(100),
...
INSERT INTO public.donnees_brutes (id, col_1, col_2, col_3, col_4, col_5, col_6, col_7, col_8, col_9, champ_libre) VALUES
