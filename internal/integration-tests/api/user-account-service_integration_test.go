...
func (s *IntegrationTestSuite) Test_UserAccountService_GetAccountTemporalConfig_HusonymCloud() {
	...
	resp, err := userclient.GetAccountTemporalConfig(
		s.ctx,
		connect.NewRequest(&mgmtv1alpha1.GetAccountTemporalConfigRequest{AccountId: accountId}),
	)
	requireErrResp(s.T(), resp, err)
...
func (s *IntegrationTestSuite) Test_UserAccountService_SetAccountTemporalConfig_HusonymCloud() {
	...
	resp, err := userclient.SetAccountTemporalConfig(
		s.ctx,
		connect.NewRequest(&mgmtv1alpha1.SetAccountTemporalConfigRequest{AccountId: accountId}),
	)
	requireErrResp(s.T(), resp, err)
	requireConnectError(s.T(), err, connect.CodeUnimplemented)
}
...
func (s *IntegrationTestSuite) Test_UserAccountService_GetAccountStatus_HusonymCloud_Personal() {
	...
	require.Equal(
		s.T(),
		mgmtv1alpha1.BillingStatus_BILLING_STATUS_TRIAL_ACTIVE,
...
func (s *IntegrationTestSuite) Test_UserAccountService_GetAccountStatus_HusonymCloud_Billed() {
	...
	t.Run("active_sub", func(t *testing.T) {
		...
		require.Equal(
			s.T(),
			mgmtv1alpha1.BillingStatus_BILLING_STATUS_ACTIVE,
			resp.Msg.GetSubscriptionStatus(),
		)
	})
	...
	t.Run("no_active_subscriptions", func(t *testing.T) {
		...
		require.Equal(
			s.T(),
			mgmtv1alpha1.BillingStatus_BILLING_STATUS_EXPIRED,
			resp.Msg.GetSubscriptionStatus(),
		)
	})
}
...
func (s *IntegrationTestSuite) Test_UserAccountService_IsAccountStatusValid_HusonymCloud_Personal() {
	...
	require.Equal(
		s.T(),
		mgmtv1alpha1.AccountStatus_ACCOUNT_STATUS_ACCOUNT_TRIAL_ACTIVE,
...
func (s *IntegrationTestSuite) Test_UserAccountService_IsAccountStatusValid_HusonymCloud_Billed() {
	...
	t.Run("no_active_subs", func(t *testing.T) {
		...
		assert.Equal(
			t,
			mgmtv1alpha1.AccountStatus_ACCOUNT_STATUS_ACCOUNT_IN_EXPIRED_STATE,
			resp.Msg.GetAccountStatus(),
		)
	...
	t.Run("no_subs_expired_trial", func(t *testing.T) {
		...
		assert.Equal(
			t,
			mgmtv1alpha1.AccountStatus_ACCOUNT_STATUS_ACCOUNT_TRIAL_EXPIRED,
			resp.Msg.GetAccountStatus(),
		)
		assert.False(t, resp.Msg.GetShouldPoll())
	})
...
func (s *IntegrationTestSuite) Test_UserAccountService_GetAccountBillingCheckoutSession() {
	...
	t.Run("billed account - allowed", func(t *testing.T) {
		...
		resp, err := userclient.GetAccountBillingCheckoutSession(
			s.ctx,
			connect.NewRequest(&mgmtv1alpha1.GetAccountBillingCheckoutSessionRequest{
...
func (s *IntegrationTestSuite) Test_UserAccountService_GetAccountBillingPortalSession() {
	...
	t.Run("billed account - allowed", func(t *testing.T) {
		...
		resp, err := userclient.GetAccountBillingPortalSession(
			s.ctx,
			connect.NewRequest(&mgmtv1alpha1.GetAccountBillingPortalSessionRequest{
				AccountId: teamAccountId,
			}),
		)
		requireNoErrResp(s.T(), resp, err)
...
func (s *IntegrationTestSuite) createBilledTeamAccount(
	ctx context.Context,
	client mgmtv1alpha1connect.UserAccountServiceClient,
...
func (s *IntegrationTestSuite) Test_GetBillingAccounts() {
	...
	au1TeamAccountId1 := s.createBilledTeamAccount(
		s.ctx,
		userclient1,
		"test-team",
		"test-stripe-id",
	)
	au1TeamAccountId2 := s.createBilledTeamAccount(
		s.ctx,
		userclient1,
		"test-team2",
		"test-stripe-id2",
	...
	au2TeamAccountId1 := s.createBilledTeamAccount(
		s.ctx,
		userclient2,
		"test-team2",
		"test-stripeid-3",
	...
	t.Run("all accounts", func(t *testing.T) {
		resp, err := workeruserclient.GetBillingAccounts(
			s.ctx,
		...
		resp, err := workeruserclient.GetBillingAccounts(
			...
			connect.NewRequest(&mgmtv1alpha1.GetBillingAccountsRequest{
				AccountIds: []string{
					au1TeamAccountId1,
					au2TeamAccountId1,
				}, // one account from two different users
			}),
		)
		requireNoErrResp(t, resp, err)
		accounts := resp.Msg.GetAccounts()
	...
	t.Run("requires worker api key", func(t *testing.T) {
		resp, err := userclient1.GetBillingAccounts(
			s.ctx,
			connect.NewRequest(&mgmtv1alpha1.GetBillingAccountsRequest{}),
		)
...
func (s *IntegrationTestSuite) Test_SetBillingMeterEvent() {
	...
	t.Run("requires worker api key", func(t *testing.T) {
		resp, err := userclient1.SetBillingMeterEvent(
			s.ctx,
			connect.NewRequest(&mgmtv1alpha1.SetBillingMeterEventRequest{}),
		)
		requireErrResp(t, resp, err)
