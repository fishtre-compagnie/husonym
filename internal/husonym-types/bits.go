...
func NewBitsFromPgx(value any, opts ...HusonymTypeOption) (*Bits, error) {
...
func NewBitsFromMysql(value any, opts ...HusonymTypeOption) (*Bits, error) {
	bits, err := NewBits(opts...)
	if err != nil {
		return nil, err
	}
...
func NewBitsFromMssql(value any, opts ...HusonymTypeOption) (*Bits, error) {
	bits, err := NewBits(opts...)
	if err != nil {
		return nil, err
	}
...
func NewBits(opts ...HusonymTypeOption) (*Bits, error) {
	bits := &Bits{}
	bits.Husonym.TypeId = HusonymBitsId
