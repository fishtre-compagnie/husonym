...
// NewDataConnection provides a mock function for the type MockConnectionDataBuilder
func (_mock *MockConnectionDataBuilder) NewDataConnection(logger *slog.Logger, connection *mgmtv1alpha1.Connection) (ConnectionDataService, error) {
	ret := _mock.Called(logger, connection)
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(*slog.Logger, *mgmtv1alpha1.Connection) (ConnectionDataService, error)); ok {
		return returnFunc(logger, connection)
	}
	if returnFunc, ok := ret.Get(0).(func(*slog.Logger, *mgmtv1alpha1.Connection) ConnectionDataService); ok {
		r0 = returnFunc(logger, connection)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ConnectionDataService)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(*slog.Logger, *mgmtv1alpha1.Connection) error); ok {
		r1 = returnFunc(logger, connection)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
func (_c *MockConnectionDataBuilder_NewDataConnection_Call) Run(run func(logger *slog.Logger, connection *mgmtv1alpha1.Connection)) *MockConnectionDataBuilder_NewDataConnection_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 *mgmtv1alpha1.Connection
		if args[1] != nil {
			arg1 = args[1].(*mgmtv1alpha1.Connection)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockConnectionDataBuilder_NewDataConnection_Call) Return(connectionDataService ConnectionDataService, err error) *MockConnectionDataBuilder_NewDataConnection_Call {
	_c.Call.Return(connectionDataService, err)
	return _c
}

func (_c *MockConnectionDataBuilder_NewDataConnection_Call) RunAndReturn(run func(logger *slog.Logger, connection *mgmtv1alpha1.Connection) (ConnectionDataService, error)) *MockConnectionDataBuilder_NewDataConnection_Call {
	_c.Call.Return(run)
	return _c
}
