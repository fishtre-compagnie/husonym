...
func New(db DBTX, q db_queries.Querier) *HusonymDb {
	if q != nil {
		return &HusonymDb{
			Db: db,
			Q:  q,
...
func NewFromConfig(config *ConnectConfig) (*HusonymDb, error) {
