...
// Begin provides a mock function for the type MockDBTX
func (_mock *MockDBTX) Begin(ctx context.Context) (pgx.Tx, error) {
...
func (_c *MockDBTX_Begin_Call) Return(tx pgx.Tx, err error) *MockDBTX_Begin_Call {
	_c.Call.Return(tx, err)
	return _c
}

func (_c *MockDBTX_Begin_Call) RunAndReturn(run func(ctx context.Context) (pgx.Tx, error)) *MockDBTX_Begin_Call {
	_c.Call.Return(run)
	return _c
}

// BeginTx provides a mock function for the type MockDBTX
func (_mock *MockDBTX) BeginTx(ctx context.Context, txOptions pgx.TxOptions) (pgx.Tx, error) {
...
func (_c *MockDBTX_BeginTx_Call) Return(tx pgx.Tx, err error) *MockDBTX_BeginTx_Call {
	_c.Call.Return(tx, err)
	return _c
}

func (_c *MockDBTX_BeginTx_Call) RunAndReturn(run func(ctx context.Context, txOptions pgx.TxOptions) (pgx.Tx, error)) *MockDBTX_BeginTx_Call {
	_c.Call.Return(run)
	return _c
}

// CopyFrom provides a mock function for the type MockDBTX
func (_mock *MockDBTX) CopyFrom(ctx context.Context, tableName pgx.Identifier, columnNames []string, rowSrc pgx.CopyFromSource) (int64, error) {
...
func (_c *MockDBTX_CopyFrom_Call) Return(n int64, err error) *MockDBTX_CopyFrom_Call {
	_c.Call.Return(n, err)
	return _c
}

func (_c *MockDBTX_CopyFrom_Call) RunAndReturn(run func(ctx context.Context, tableName pgx.Identifier, columnNames []string, rowSrc pgx.CopyFromSource) (int64, error)) *MockDBTX_CopyFrom_Call {
	_c.Call.Return(run)
	return _c
}

// Exec provides a mock function for the type MockDBTX
func (_mock *MockDBTX) Exec(context1 context.Context, s string, anyMoqParams ...any) (pgconn.CommandTag, error) {
	var _ca []any
	_ca = append(_ca, context1, s)
	_ca = append(_ca, anyMoqParams...)
...
//   - s string
//   - anyMoqParams ...any
func (_e *MockDBTX_Expecter) Exec(context1 any, s any, anyMoqParams ...any) *MockDBTX_Exec_Call {
	return &MockDBTX_Exec_Call{Call: _e.mock.On("Exec",
		append([]any{context1, s}, anyMoqParams...)...)}
}

func (_c *MockDBTX_Exec_Call) Run(run func(context1 context.Context, s string, anyMoqParams ...any)) *MockDBTX_Exec_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockDBTX_Exec_Call) RunAndReturn(run func(context1 context.Context, s string, anyMoqParams ...any) (pgconn.CommandTag, error)) *MockDBTX_Exec_Call {
	_c.Call.Return(run)
	return _c
}

// Ping provides a mock function for the type MockDBTX
func (_mock *MockDBTX) Ping(ctx context.Context) error {
	ret := _mock.Called(ctx)
...
func (_c *MockDBTX_Ping_Call) Return(err error) *MockDBTX_Ping_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockDBTX_Ping_Call) RunAndReturn(run func(ctx context.Context) error) *MockDBTX_Ping_Call {
	_c.Call.Return(run)
	return _c
}

// Query provides a mock function for the type MockDBTX
func (_mock *MockDBTX) Query(context1 context.Context, s string, anyMoqParams ...any) (pgx.Rows, error) {
	var _ca []any
	_ca = append(_ca, context1, s)
	_ca = append(_ca, anyMoqParams...)
	ret := _mock.Called(_ca...)
...
//   - s string
//   - anyMoqParams ...any
func (_e *MockDBTX_Expecter) Query(context1 any, s any, anyMoqParams ...any) *MockDBTX_Query_Call {
	return &MockDBTX_Query_Call{Call: _e.mock.On("Query",
		append([]any{context1, s}, anyMoqParams...)...)}
}

func (_c *MockDBTX_Query_Call) Run(run func(context1 context.Context, s string, anyMoqParams ...any)) *MockDBTX_Query_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockDBTX_Query_Call) RunAndReturn(run func(context1 context.Context, s string, anyMoqParams ...any) (pgx.Rows, error)) *MockDBTX_Query_Call {
	_c.Call.Return(run)
	return _c
}

// QueryRow provides a mock function for the type MockDBTX
func (_mock *MockDBTX) QueryRow(context1 context.Context, s string, anyMoqParams ...any) pgx.Row {
	var _ca []any
	_ca = append(_ca, context1, s)
	_ca = append(_ca, anyMoqParams...)
	ret := _mock.Called(_ca...)
...
//   - s string
//   - anyMoqParams ...any
func (_e *MockDBTX_Expecter) QueryRow(context1 any, s any, anyMoqParams ...any) *MockDBTX_QueryRow_Call {
	return &MockDBTX_QueryRow_Call{Call: _e.mock.On("QueryRow",
		append([]any{context1, s}, anyMoqParams...)...)}
}

func (_c *MockDBTX_QueryRow_Call) Run(run func(context1 context.Context, s string, anyMoqParams ...any)) *MockDBTX_QueryRow_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockDBTX_QueryRow_Call) RunAndReturn(run func(context1 context.Context, s string, anyMoqParams ...any) pgx.Row) *MockDBTX_QueryRow_Call {
	_c.Call.Return(run)
	return _c
}
