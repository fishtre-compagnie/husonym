...
// UserDefinedTransformerResolver gives the configuration a user-defined transformer
// stands for. Declared here rather than taken from the transformer executor, which would
// pull every transformer into a package the whole workflow imports.
...
func BenthosRuns(ctx context.Context, job *mgmtv1alpha1.Job, resolver UserDefinedTransformerResolver) error {
